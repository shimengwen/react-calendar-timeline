...
export default class ReactCalendarTimeline extends Component {
  ...
  constructor(props) {
    ...
    const [canvasTimeStart, canvasTimeEnd] = props.endless ? getCanvasBoundariesFromVisibleTime(
      visibleTimeStart,
      visibleTimeEnd
    ...
    const minUnit = getMinUnit(zoom, this.state.width, props.timeSteps)
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    ...
    if (visibleTimeStart && visibleTimeEnd) {
      ...
      const zoom = prevState.visibleTimeEnd - prevState.visibleTimeStart
      const minUnit = getMinUnit(zoom, prevState.width, nextProps.timeSteps)
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (
      ...
      this.props.onBoundsChange(
        this.state.canvasTimeStart,
        prevProps.endless ? this.state.canvasTimeStart + newZoom * 3 : this.state.canvasTimeEnd
      )
    }
  ...
  sidebar(height, groupHeights) {
    const { sidebarWidth, showScroll } = this.props
    return (
      sidebarWidth && (
        <Sidebar
  ...
  render() {
    ...
    const new_height = showScroll == true ? height + 20 : height;
          ...
          >
            ...
            >
              ...
              <div style={outerComponentStyle} className="rct-outer">
                {sidebarWidth > 0 ? this.sidebar(new_height, groupHeights) : null}
                <ScrollElement
                ...
                >
                  <MarkerCanvas>
                    ...
                    {endless ? this.childrenWithProps(
                      canvasTimeStart,
                      canvasTimeEnd,
                      canvasWidth,
                      dimensionItems,
